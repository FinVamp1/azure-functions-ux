...
import { LogCategories, NotificationIds, Constants } from './../shared/models/constants';
...
export class FunctionEditComponent implements OnDestroy {
    ...
    constructor(
        ...
        this._broadcastService.getEvents<TreeViewInfo<any>>(BroadcastEvent.TreeNavigation)
            ...
            .switchMap(viewInfo => {
                // TODO: ellhamai - move to busy manager
            ...
            .switchMap(context => {
                ...
                return this._functionsService.getFunction(context, functionDescriptor.functionName);
            })
